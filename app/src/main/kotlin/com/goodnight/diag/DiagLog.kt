 ...
 * 事后无从取证。现在每条同时写:
 *   1) logcat(tag `GoodNightDiag`,便于 adb 实时跟)
 *   2) `Android/data/com.goodnight/files/diag.log`(adb pull 可取,超 512 KiB 滚动为 diag.log.1)
 *
...
object DiagLog {
    ...
    private const val TAG_LOG = "GoodNightDiag"
