...
import com.goodnight.diag.DiagnosticsSection
...
import com.goodnight.ui.theme.ThemePack
...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                DiagnosticsSection(serviceAliveFlag = { com.goodnight.diag.DiagState.serviceAlive })
            }
