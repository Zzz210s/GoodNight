...
class TimerEngineTaskCutTest {
    ...
    @Test fun pausedSwitchCutsAtPauseStartNotSwitchMoment() = runTest {
        ...
        assertEquals(
            listOf(Triple(segStart, null, 1L), Triple(t1, 1L, 2L)),
            e.snapshot.value!!.taskCutPoints(),
        )
    ...
    @Test fun cutsSurviveRestart() = runTest {
        ...
        e.setTask(2L)
        val cuts = listOf(Triple(segStart, null, 1L), Triple(t.nowMs, 1L, 2L))
